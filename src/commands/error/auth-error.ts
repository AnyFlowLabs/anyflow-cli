export function handleAuthError(error: any) {
    ...
    console.error('\n🔍 Need Help?');
    console.error('  • Documentation: https://docs.anyflow.xyz');
    console.error('  • Report issues: https://github.com/anyflow/anyflow-cli/issues');
    console.error('  • Support: support@anyflow.xyz\n');
}